...
<!-- 					<p class="mb-30">Сначала мы просто поговорим. Это вас ни к чему не обязывает</p> -->
	...
	<div id="contact-modal" class="sentence-modal white-popup-block mfp-hide  no-padding">
		...
		<div class="modal-container">
			<div class="row position-relative align-center">
				<div class="col-xs-12">
				<span class="modal-header-caption mt-20">Регистрация на курс </br> Легкий старт - 3500 ₽</span>
				
					<form action="https://ovsyannikova.pro/regMail.php" method="POST">
					...
					<div class="input-group mb-3">
						...
						<input type="tel" class="form-control tel" placeholder="Телефон" required name="tel">
					</div>

					<div class="input-group mb-3">
					
						<input type="text" class="form-control" placeholder="Возраст" required name="age">
					</div>
					...
					<div class="input-group mb-3">
						...
						<input type="email" class="form-control" placeholder="Почта" required name="mail">
					</div>
					<input type="hidden"  name="tarif"  value="Легкий старт  3500 ₽">
					<div class="input-group mb-3">
						<input type="submit" class=" button-brown " style="width: 226px;" value="Записаться"/> 
					</div>
	...
	<div id="contact-modal1" class="sentence-modal white-popup-block mfp-hide  no-padding">
		<div class="close-modal"><i class="fa fa-close"></i></div>
		<div class="modal-container">
			<div class="row position-relative align-center">
				<div class="col-xs-12">
					<span class="modal-header-caption mt-20">Регистрация на курс </br>Стандарт - 7500 ₽</span>
					<form action="https://ovsyannikova.pro/regMail.php" method="POST">
						<div style="display: grid;
    						justify-items: center;
   							 grid-gap: 10px;     padding-top: 10px;">
					...
					<input type="hidden" name="tarif" value="Стандарт 7500 ₽">
					<div class="input-group mb-3">
						<input type="submit" class=" button-brown " style="width: 226px;" value="Записаться"/> 
					</div>
	...
	<div id="contact-modal2" class="sentence-modal white-popup-block mfp-hide  no-padding">
		<div class="close-modal"><i class="fa fa-close"></i></div>
		<div class="modal-container">
			<div class="row position-relative align-center">
				<div class="col-xs-12">
					<span class="modal-header-caption mt-20">Регистрация на курс </br>VIP - 25 000 ₽</span>
					<form action="https://ovsyannikova.pro/regMail.php" method="POST">
						<div style="display: grid;
    						justify-items: center;
   							 grid-gap: 10px;     padding-top: 10px;">
					...
					<div class="input-group mb-3">
						...
						<input type="tel" class="tel form-control" placeholder="Телефон" required name="tel">
					</div>
					...
					<input type="hidden" name="tarif" value="VIP 25 000 ₽">
					<div class="input-group mb-3">
						<input type="submit" class=" button-brown " style="width: 226px;" value="Записаться"/> 
					</div>
